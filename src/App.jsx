...
const DEFAULT_CODES = [
  {id:1,code:'SS400',standard:'KS D 3503',description:'일반구조용 압연강재',
    chemical:{P:{max:0.05},S:{max:0.05}},
    mechanical:{yieldStrength:{min:245},tensileStrength:{min:400,max:510},elongation:{min:21}}},
  {id:7,code:'SM520B',standard:'KS D 3515',description:'용접구조용 압연강재',
    chemical:{C:{max:0.2},Si:{max:0.55},Mn:{max:1.65},P:{max:0.035},S:{max:0.035}},
    mechanical:{yieldStrength:{min:365},tensileStrength:{min:520,max:640},elongation:{min:15}}},
  {id:9,code:'ASTM A36',standard:'ASTM A36',description:'일반구조용 탄소강',
    chemical:{C:{max:0.26},P:{max:0.04},S:{max:0.05}},
    mechanical:{yieldStrength:{min:250},tensileStrength:{min:400,max:550},elongation:{min:20}}},
  {id:10,code:'A572 Gr.50',standard:'ASTM A572',description:'고장력 저합금 구조용강',
    chemical:{C:{max:0.23},Si:{max:0.4},Mn:{max:1.35},P:{max:0.04},S:{max:0.05}},
    mechanical:{yieldStrength:{min:345},tensileStrength:{min:450,max:620},elongation:{min:18}}},
  {id:11,code:'SGCC',standard:'KS D 3506',description:'용융아연도금강판',
    chemical:{C:{max:0.15},Si:{max:0.5},Mn:{max:0.8},P:{max:0.05},S:{max:0.05}},
    mechanical:{yieldStrength:{min:205},tensileStrength:{min:270},elongation:{min:20}}},
  {id:12,code:'SPHC',standard:'JIS G 3131',description:'HOT TOLLED COIL',
    chemical:{C:{max:0.15},Mn:{max:0.6},P:{max:0.05},S:{max:0.05}},
    mechanical:{tensileStrength:{min:270},elongation:{min:27}}},
  {id:13,code:'SS400',standard:'JIS G 3101',description:'HOT ROLLED COIL',
    chemical:{P:{max:0.05},S:{max:0.05}},
    mechanical:{yieldStrength:{min:245},tensileStrength:{min:400,max:510},elongation:{min:21}}},
  {id:14,code:'S45C',standard:'JIS G 4051',description:'마사각',
    chemical:{C:{min:0.42,max:0.48},Si:{min:0.15,max:0.35},Mn:{min:0.6,max:0.9},P:{max:0.03},S:{max:0.035}},
    mechanical:{}},
  {id:15,code:'SPCC',standard:'KS D 3512',description:'COLD ROLLED COIL',
    chemical:{C:{max:0.15},Mn:{max:0.6},P:{max:0.05},S:{max:0.05}},
    mechanical:{yieldStrength:{max:280},tensileStrength:{max:410},elongation:{min:27}}},
  {id:16,code:'SGHC',standard:'KS D 3506',description:'GALVANIZED STEEL SHEET',
    chemical:{C:{max:0.15},Mn:{max:0.5},P:{max:0.05},S:{max:0.05}},
    mechanical:{yieldStrength:{min:205},tensileStrength:{min:270}}},
  {id:17,code:'CS TYPE A',standard:'ASTM A653',description:'GALVANIZED STEEL SHEET',
    chemical:{C:{max:0.1},Mn:{max:0.6},P:{max:0.03},S:{max:0.035},Cu:{max:0.25},Ni:{max:0.2},Cr:{max:0.15},Mo:{max:0.06},V:{max:0.008},Nb:{max:0.008},Ti:{max:0.025}},
    mechanical:{yieldStrength:{min:170,max:380},elongation:{min:20}}},
];
